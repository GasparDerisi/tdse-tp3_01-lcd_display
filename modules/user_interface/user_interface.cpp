...
#define DISPLAY_CONNECTION_MODE_0 (0)
#define DISPLAY_CONNECTION_MODE_1 (1)
#define DISPLAY_CONNECTION_MODE_2 (2)

#define DISPLAY_CONNECTION_MODE (DISPLAY_CONNECTION_MODE_0)
